...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "userge.on"
...
async def snku(ult):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [userge.on IS BEST](https://github.com/Teamuserge.on/userge.on) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if ult.fwd_from:
        return
...
@userge.on_cmd(pattern="gangasta$")
async def snku(ult):
...
@userge.on_cmd(pattern=f"charging$")
async def snku(ult):
    txt = (
        e.text[10:]
...
@userge.on_cmd(pattern=r"nothappy$")
async def snku(ult):
    if ult.fwd_from:
        return
...
@userge.on_cmd(pattern="fleaveme$")
async def snku(ult):
    animation_interval = 1
...
@userge.on_cmd(pattern="solarsystem")
async def snku(ult):
    if ult.fwd_from:
        return
    animation_interval = 0.1
...
@userge.on_cmd(pattern="bufferedd( (.*)|$)")
async def snku(ult):
    if ult.fwd_from:
        return
    animation_interval = 0.3
...
@userge.on_cmd(pattern=r"fdance")
async def snku(ult):
    if ult.fwd_from:
        return
    animation_interval = 1
...
@userge.on_cmd(outgoing=True, pattern="kf$(.*)")
async def _(event):
